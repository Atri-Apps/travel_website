...
const TextBox787Cb = useTextBox787Cb()
  ...
  return (<>
  <Flex2 className="p-places Places_Body bpt" {...Places_BodyProps} {...Places_BodyCb} {...Places_BodyIoProps}>
<Flex2 className="p-places Flex443 bpt" {...Flex443Props} {...Flex443Cb} {...Flex443IoProps}>
<Image2 className="p-places Image314 bpt" {...Image314Props} {...Image314Cb} {...Image314IoProps}/>
<TextBox2 className="p-places TextBox779 bpt" {...TextBox779Props} {...TextBox779Cb} {...TextBox779IoProps}/>
<TextBox2 className="p-places TextBox778 bpt" {...TextBox778Props} {...TextBox778Cb} {...TextBox778IoProps}/>
<TextBox2 className="p-places TextBox777 bpt" {...TextBox777Props} {...TextBox777Cb} {...TextBox777IoProps}/>
<TextBox2 className="p-places TextBox776 bpt" {...TextBox776Props} {...TextBox776Cb} {...TextBox776IoProps}/>
<Button2 className="p-places Button43 bpt" {...Button43Props} {...Button43Cb} {...Button43IoProps}/>
</Flex2>
<Flex2 className="p-places Flex277 bpt" {...Flex277Props} {...Flex277Cb} {...Flex277IoProps}>
<TextBox2 className="p-places TextBox459 bpt" {...TextBox459Props} {...TextBox459Cb} {...TextBox459IoProps}/>
<TextBox2 className="p-places TextBox458 bpt" {...TextBox458Props} {...TextBox458Cb} {...TextBox458IoProps}/>
<Flex2 className="p-places Flex276 bpt" {...Flex276Props} {...Flex276Cb} {...Flex276IoProps}>
<Div1 className="p-places Div177 bpt" {...Div177Props} {...Div177Cb} {...Div177IoProps}>
<Image2 className="p-places Image171 bpt" {...Image171Props} {...Image171Cb} {...Image171IoProps}/>
<TextBox2 className="p-places TextBox457 bpt" {...TextBox457Props} {...TextBox457Cb} {...TextBox457IoProps}/>
</Div1>
<Div1 className="p-places Div174 bpt" {...Div174Props} {...Div174Cb} {...Div174IoProps}>
<Image2 className="p-places Image168 bpt" {...Image168Props} {...Image168Cb} {...Image168IoProps}/>
<TextBox2 className="p-places TextBox454 bpt" {...TextBox454Props} {...TextBox454Cb} {...TextBox454IoProps}/>
</Div1>
<Div1 className="p-places Div175 bpt" {...Div175Props} {...Div175Cb} {...Div175IoProps}>
<Image2 className="p-places Image169 bpt" {...Image169Props} {...Image169Cb} {...Image169IoProps}/>
<TextBox2 className="p-places TextBox455 bpt" {...TextBox455Props} {...TextBox455Cb} {...TextBox455IoProps}/>
</Div1>
<Div1 className="p-places Div176 bpt" {...Div176Props} {...Div176Cb} {...Div176IoProps}>
<Image2 className="p-places Image170 bpt" {...Image170Props} {...Image170Cb} {...Image170IoProps}/>
<TextBox2 className="p-places TextBox456 bpt" {...TextBox456Props} {...TextBox456Cb} {...TextBox456IoProps}/>
</Div1>
</Flex2>
</Flex2>
<Flex2 className="p-places Flex449 bpt" {...Flex449Props} {...Flex449Cb} {...Flex449IoProps}>
<Flex2 className="p-places Flex446 bpt" {...Flex446Props} {...Flex446Cb} {...Flex446IoProps}>
<Flex2 className="p-places Flex445 bpt" {...Flex445Props} {...Flex445Cb} {...Flex445IoProps}>
<Image2 className="p-places Image318 bpt" {...Image318Props} {...Image318Cb} {...Image318IoProps}/>
</Flex2>
<Flex2 className="p-places Flex444 bpt" {...Flex444Props} {...Flex444Cb} {...Flex444IoProps}>
<Image2 className="p-places Image315 bpt" {...Image315Props} {...Image315Cb} {...Image315IoProps}/>
<Image2 className="p-places Image316 bpt" {...Image316Props} {...Image316Cb} {...Image316IoProps}/>
<Image2 className="p-places Image317 bpt" {...Image317Props} {...Image317Cb} {...Image317IoProps}/>
</Flex2>
</Flex2>
<Flex2 className="p-places Flex447 bpt" {...Flex447Props} {...Flex447Cb} {...Flex447IoProps}>
<TextBox2 className="p-places TextBox781 bpt" {...TextBox781Props} {...TextBox781Cb} {...TextBox781IoProps}/>
<TextBox2 className="p-places TextBox782 bpt" {...TextBox782Props} {...TextBox782Cb} {...TextBox782IoProps}/>
<TextBox2 className="p-places TextBox783 bpt" {...TextBox783Props} {...TextBox783Cb} {...TextBox783IoProps}/>
<TextBox2 className="p-places TextBox780 bpt" {...TextBox780Props} {...TextBox780Cb} {...TextBox780IoProps}/>
</Flex2>
<Flex2 className="p-places Flex448 bpt" {...Flex448Props} {...Flex448Cb} {...Flex448IoProps}>
<TextBox2 className="p-places TextBox785 bpt" {...TextBox785Props} {...TextBox785Cb} {...TextBox785IoProps}/>
<TextBox2 className="p-places TextBox786 bpt" {...TextBox786Props} {...TextBox786Cb} {...TextBox786IoProps}/>
<TextBox2 className="p-places TextBox787 bpt" {...TextBox787Props} {...TextBox787Cb} {...TextBox787IoProps}/>
<TextBox2 className="p-places TextBox784 bpt" {...TextBox784Props} {...TextBox784Cb} {...TextBox784IoProps}/>
</Flex2>
<Image2 className="p-places Image319 bpt" {...Image319Props} {...Image319Cb} {...Image319IoProps}/>
</Flex2>
</Flex2>
  </>);
}
