...
const Image266Cb = useImage266Cb()
  ...
  return (<>
  <Flex6 className="p-privacy-policy Privacy_Policy bpt" {...Privacy_PolicyProps} {...Privacy_PolicyCb} {...Privacy_PolicyIoProps}>
<Flex6 className="p-privacy-policy Flex364 bpt" {...Flex364Props} {...Flex364Cb} {...Flex364IoProps}>
<Image6 className="p-privacy-policy Image262 bpt" {...Image262Props} {...Image262Cb} {...Image262IoProps}/>
<TextBox6 className="p-privacy-policy TextBox660 bpt" {...TextBox660Props} {...TextBox660Cb} {...TextBox660IoProps}/>
<TextBox6 className="p-privacy-policy TextBox659 bpt" {...TextBox659Props} {...TextBox659Cb} {...TextBox659IoProps}/>
<TextBox6 className="p-privacy-policy TextBox658 bpt" {...TextBox658Props} {...TextBox658Cb} {...TextBox658IoProps}/>
<TextBox6 className="p-privacy-policy TextBox657 bpt" {...TextBox657Props} {...TextBox657Cb} {...TextBox657IoProps}/>
<Button6 className="p-privacy-policy Button37 bpt" {...Button37Props} {...Button37Cb} {...Button37IoProps}/>
</Flex6>
<Div4 className="p-privacy-policy Div227 bpt" {...Div227Props} {...Div227Cb} {...Div227IoProps}>
<TextBox6 className="p-privacy-policy TextBox672 bpt" {...TextBox672Props} {...TextBox672Cb} {...TextBox672IoProps}/>
<TextBox6 className="p-privacy-policy TextBox671 bpt" {...TextBox671Props} {...TextBox671Cb} {...TextBox671IoProps}/>
<TextBox6 className="p-privacy-policy TextBox670 bpt" {...TextBox670Props} {...TextBox670Cb} {...TextBox670IoProps}/>
<TextBox6 className="p-privacy-policy TextBox669 bpt" {...TextBox669Props} {...TextBox669Cb} {...TextBox669IoProps}/>
<TextBox6 className="p-privacy-policy TextBox663 bpt" {...TextBox663Props} {...TextBox663Cb} {...TextBox663IoProps}/>
<TextBox6 className="p-privacy-policy TextBox668 bpt" {...TextBox668Props} {...TextBox668Cb} {...TextBox668IoProps}/>
<TextBox6 className="p-privacy-policy TextBox666 bpt" {...TextBox666Props} {...TextBox666Cb} {...TextBox666IoProps}/>
<TextBox6 className="p-privacy-policy TextBox664 bpt" {...TextBox664Props} {...TextBox664Cb} {...TextBox664IoProps}/>
<TextBox6 className="p-privacy-policy TextBox662 bpt" {...TextBox662Props} {...TextBox662Cb} {...TextBox662IoProps}/>
<TextBox6 className="p-privacy-policy TextBox665 bpt" {...TextBox665Props} {...TextBox665Cb} {...TextBox665IoProps}/>
<TextBox6 className="p-privacy-policy TextBox667 bpt" {...TextBox667Props} {...TextBox667Cb} {...TextBox667IoProps}/>
<TextBox6 className="p-privacy-policy TextBox661 bpt" {...TextBox661Props} {...TextBox661Cb} {...TextBox661IoProps}/>
</Div4>
<Flex6 className="p-privacy-policy Flex370 bpt" {...Flex370Props} {...Flex370Cb} {...Flex370IoProps}>
<Flex6 className="p-privacy-policy Flex369 bpt" {...Flex369Props} {...Flex369Cb} {...Flex369IoProps}>
<Flex6 className="p-privacy-policy Flex365 bpt" {...Flex365Props} {...Flex365Cb} {...Flex365IoProps}>
<Image6 className="p-privacy-policy Image263 bpt" {...Image263Props} {...Image263Cb} {...Image263IoProps}/>
</Flex6>
<Flex6 className="p-privacy-policy Flex366 bpt" {...Flex366Props} {...Flex366Cb} {...Flex366IoProps}>
<Image6 className="p-privacy-policy Image266 bpt" {...Image266Props} {...Image266Cb} {...Image266IoProps}/>
<Image6 className="p-privacy-policy Image265 bpt" {...Image265Props} {...Image265Cb} {...Image265IoProps}/>
<Image6 className="p-privacy-policy Image264 bpt" {...Image264Props} {...Image264Cb} {...Image264IoProps}/>
</Flex6>
</Flex6>
<Flex6 className="p-privacy-policy Flex368 bpt" {...Flex368Props} {...Flex368Cb} {...Flex368IoProps}>
<TextBox6 className="p-privacy-policy TextBox679 bpt" {...TextBox679Props} {...TextBox679Cb} {...TextBox679IoProps}/>
<TextBox6 className="p-privacy-policy TextBox678 bpt" {...TextBox678Props} {...TextBox678Cb} {...TextBox678IoProps}/>
<TextBox6 className="p-privacy-policy TextBox677 bpt" {...TextBox677Props} {...TextBox677Cb} {...TextBox677IoProps}/>
<TextBox6 className="p-privacy-policy TextBox680 bpt" {...TextBox680Props} {...TextBox680Cb} {...TextBox680IoProps}/>
</Flex6>
<Flex6 className="p-privacy-policy Flex367 bpt" {...Flex367Props} {...Flex367Cb} {...Flex367IoProps}>
<TextBox6 className="p-privacy-policy TextBox675 bpt" {...TextBox675Props} {...TextBox675Cb} {...TextBox675IoProps}/>
<TextBox6 className="p-privacy-policy TextBox674 bpt" {...TextBox674Props} {...TextBox674Cb} {...TextBox674IoProps}/>
<TextBox6 className="p-privacy-policy TextBox673 bpt" {...TextBox673Props} {...TextBox673Cb} {...TextBox673IoProps}/>
<TextBox6 className="p-privacy-policy TextBox676 bpt" {...TextBox676Props} {...TextBox676Cb} {...TextBox676IoProps}/>
</Flex6>
<Image6 className="p-privacy-policy Image267 bpt" {...Image267Props} {...Image267Cb} {...Image267IoProps}/>
</Flex6>
</Flex6>
  </>);
}
